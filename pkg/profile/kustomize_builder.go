...
func (k *KustomizeBuilder) Build(artifact profilesv1.Artifact, installation profilesv1.ProfileInstallation, definition profilesv1.ProfileDefinition) ([]Artifact, error) {
	...
	a.Objects = append(a.Objects, k.makeKustomization(artifact, path, installation, definition))
...
func (k *KustomizeBuilder) makeKustomization(artifact profilesv1.Artifact, repoPath string, installation profilesv1.ProfileInstallation, definition profilesv1.ProfileDefinition) *kustomizev1.Kustomization {
